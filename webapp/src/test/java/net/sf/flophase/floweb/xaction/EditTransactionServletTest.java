 ...
 */
public class EditTransactionServletTest extends AbstractServletTestCase {
	 ...
	 * The servlet path.
	 */
	public static final String SERVLET_PATH = "/xaction-edit";
	...
	protected Class<? extends HttpServlet> getServletClass() {
		return EditTransactionServlet.class;
	}
